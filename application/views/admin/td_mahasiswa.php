...
<?php
echo form_open('admin/c_admin/simpan_m');
?>
    <!-- Main content -->
                    ...
                    <div class="col-lg-12">
                       <div class="form-group">
                            ...
                            <label>Dosen Penasehat Akademik</label>
                                <input class="form-control" name='dosen_pa' >    
                            ...
                            <div class="input-group">
                              ...
                              <input class="form-control" name='tanggal_lahir' data-inputmask="'alias': 'yyyy/mm/dd'" data-mask>
                            </div>
                            ...
                            <label>Golongan Darah</label>
                              <input class="form-control" name='golongan_darah' >                                
                            </div>
                        </div>
                    </div>
              <!-- /.box-body -->
