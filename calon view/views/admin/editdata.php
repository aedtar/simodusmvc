...
<?php
echo form_open('auth/edit_simpan');
?>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Data Login</h3>
            </div>
            <!-- /.box-header -->
            ...
            <form role="form">
                       ...
                       <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <label>Username(Nim/Nidn)</label>
                                <input class="form-control" name='username' value="<?php echo $edit['username'];?>">
              ...
              <div class="box-footer">
                <button class="btn btn-primary btn-block" type="submit" name="simpan_data">Simpan Data</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
