...
<head>
  ...
  <title>SIPAA | Tampilah Data</title>
...
<div class="wrapper">
  ...
  <?php
echo form_open('c_admin/simpan_mhs');
?>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tampilan Data Mahasiswa</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                <thead>
                <tr>
                <td width=5><a href="<?php echo base_url(); ?>index.php/admin/c_admin/tdm"><i class="fa fa-plus"></i></td>
                    <th>No</th>
                    <th>NIM</th>
                    <th>Nama</th>
                    <th>Jenis Kelamin</th>
                ...
                <div class="table-responsive">
                  <thead>
                   <?php
                      $n=0;
                          foreach ($datam as $c){ $n++; ?>
                            <tr>
                            <td></td>
                            <td><?=$n?></td>
                            <td><?php echo $c->nim; ?></td>
                            <td><?php echo $c->nama; ?></td>
                            <td><?php echo $c->kelamin; ?></td>
                            <td><?php echo $c->fakultas; ?></td>
                            <td><?php echo $c->jurusan; ?></td>
                            <td><?php echo $c->dosen_pa; ?></td>
                            <td><?php echo $c->tempat_lahir; ?></td>
                            <td><?php echo $c->tanggal_lahir; ?></td>
                            <td><?php echo $c->agama; ?></td>
                            <td><?php echo $c->golongan_darah; ?></td>
                           
                            <td width=5><?php echo anchor('auth/edit_mhs/'.$c->nim,'<i class=" fa fa-edit"></i>')  ?></td>
                            <td width=5><?php echo anchor('auth/deletemhs/'.$c->nim,'<i class="fa fa-trash"></i>')  ?></td>
                                            </tr>
                                <?php } ?>
                                </tbody>
                            </table>
